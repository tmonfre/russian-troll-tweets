...
##
## This script produces the graph in a size fit for Qualtrics. Specifically, it shortens the title and caption,
## removes one label, and adjusts the location of the labels for clarity purposes. The data is unchanged.
##
## Name: Thomas Monfre
## Date: August 8, 2019
